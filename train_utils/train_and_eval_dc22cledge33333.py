...
def criterion3clz4(inputs, target,edgemask):
    ...
    for name, x in inputs.items():
        ...
        if name=='edge' or name=='edge2':
            ...
            losses[name]=0.1*dcv2(edgemask,x)

    # if len(losses) == 1:
        # return losses['out']

    # return losses['out'] +losses['feature']
    # return losses['out']
    # return losses['out'] + losses['x4'] + losses['x3'] + losses['feature'] + losses['edge'] + losses['edge2']
    # return losses['out'] +  losses['x4'] + losses['x3']
    # return losses['out'] + losses['x4'] + losses['x3'] + losses['edge'] + losses['edge2']
    # return losses['out'] #oneloss
    return losses['out']+ losses['edge'] #twoloss
    # return losses['out'] + losses['x4'] + losses['x3']
