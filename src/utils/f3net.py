...
class FAD_Head(nn.Module):
    ...
    def forward(self, x):
        ...
        return out
class FAD_Head1(nn.Module):
    def __init__(self, size):
        super(FAD_Head1, self).__init__()
    ...
    def forward(self, x):
        ...
        out = torch.cat(y_list, dim=1)  # [N, 12, 299, 299]
        return out
class FAD_Head2(nn.Module):
    def __init__(self, size):
        super(FAD_Head2, self).__init__()
