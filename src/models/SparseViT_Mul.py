from src.models.SparseViT import SparseViT
import torch.nn as nn
import torch
import torch.nn.functional as F
from functools import partial
from timm.models.layers import trunc_normal_
from src.models.decoderhead import Multiple
...
class SparseViT_Mul(nn.Module):
    ...
    def forward(self, image, mask,edge,*args, **kwargs):
        ...
        pred_mask = F.interpolate(image, size = (self.img_size, self.img_size), mode='bilinear', align_corners=False)

        loss_ce = self.loss_fn(pred_mask, mask.unsqueeze(1).float())
