...
from src.models.pscc_net.seg_hrnet_config import get_hrnet_cfg
from src.models.pscc_net.seg_hrnet import get_seg_model
from src.models.pscc_net.NLCDetection import NLCDetection
from src.models.pscc_net.detection_head import DetectionHead
...
class PSCC_Net(nn.Module):
    def __init__(self,
                 input_size: int = 256,
                 pretrain_path: str = '/raid/csh/TruFor-main/HRNet.pth'
                 ):
    ...
    def forward(self, image, mask,  *args, **kwargs):
        ...
        # weight
        mask1, mask2, mask3, mask4 = self.generate_4mask(mask.unsqueeze(1))
        mask1_balance, mask2_balance, mask3_balance, mask4_balance = self.get_mask_weight(mask.unsqueeze(1))
...
#
# model = PSCC_Net(pretrain_path='/raid/csh/TruFor-main/HRNet.pth')
#
