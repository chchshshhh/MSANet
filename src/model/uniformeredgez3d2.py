...
class FcnNet(nn.Module):
    def __init__(self,
        ...
        self.siu3 = SIU4(64)
        self.siu4 = SIU4(64)
        self.ac_head1 = Disentangler(64)
        self.ac_head2 = Disentangler(64)
        self.ac_head3 = Disentangler(64)
        self.ac_head4 = Disentangler(64)
    ...
    def forward(self, x1: torch.Tensor,x2,x3, hh=384, ww=384,t=True) -> Dict[str, torch.Tensor]:
        ...
        fg_feats5, bg_feats5, ccam5 = self.ac_head1(feat5)
        fg_feats4, bg_feats4, ccam4 = self.ac_head2(feat4)
        fg_feats3, bg_feats3, ccam3 = self.ac_head3(feat3)
        fg_feats2, bg_feats2, ccam2 = self.ac_head4(feat2)

        fg_feats5 = fg_feats5.unsqueeze(1)
        fg_feats4 = fg_feats4.unsqueeze(1)
        fg_feats3 = fg_feats3.unsqueeze(1)
        fg_feats2 = fg_feats2.unsqueeze(1)

        bg_feats5 = bg_feats5.unsqueeze(1)
        bg_feats4 = bg_feats4.unsqueeze(1)
        bg_feats3 = bg_feats3.unsqueeze(1)
        bg_feats2 = bg_feats2.unsqueeze(1)


        fg_feats = torch.cat([fg_feats5, fg_feats4,fg_feats3,fg_feats2], dim=1)
        bg_feats = torch.cat([bg_feats5,bg_feats4,bg_feats3,bg_feats2],dim=1)
        ...
        return {"out": x, 'fore':fg_feats,'back':bg_feats}
