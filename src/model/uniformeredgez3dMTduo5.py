...
class FcnNet(nn.Module):
    def __init__(self,
        ...
        weights_dict = torch.load('/root/data/IRLpeng3/uniformer_small_tl_384.pth')
        ...
        self.att=MultiSpectralAttentionLayer(64,96,96)
    ...
    def forward(self, x1: torch.Tensor,x2,x3, hh=384, ww=384,t=True) -> Dict[str, torch.Tensor]:
        ...
        # x2_a=self.up2(feat3)
        # x3_a=self.up4(feat4)
        # x4_a=self.up2(self.up4(feat5))
        # x_a=torch.cat([x1_a,x2_a,x3_a,x4_a],dim=1)
        # x4_ad=self.ad1(x4_f)
        # x3_ad=self.ad2(x3_f)
        # x2_ad=self.ad3(x2_f)
        # x1_ad=self.ad4(x1_f)
