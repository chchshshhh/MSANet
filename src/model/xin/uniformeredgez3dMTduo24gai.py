...
class SIUonlyh(nn.Module):
    def __init__(self, in_dim):
        ...
        self.trans = nn.Sequential(
            ConvBNReLU(2 * in_dim, in_dim,3,1,1),
    ...
    def forward(self, s, m,l, return_feats=False):
        ...
        sm = self.trans(torch.cat([s,m], dim=1))
...
class FcnNet(nn.Module):
    def __init__(self,
        ...
        self.siu1 = SIUonlyh(64)
        self.siu2 = SIUonlyh(64)
        self.siu3 = SIUonlyh(64)
        self.siu4 = SIUonlyh(64)
