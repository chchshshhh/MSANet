...
class FcnNet(nn.Module):
    def __init__(self,
        ...
        self.siu1 = SIUonly2(64)
        self.siu2 = SIUonly2(64)
        self.siu3 = SIUonly2(64)
        self.siu4 = SIUonly2(64)
    ...
    def forward(self, x1: torch.Tensor,x2,x3, hh=384, ww=384,t=True) -> Dict[str, torch.Tensor]:
        ...
        feat2 = self.siu1(xl1, xm1, xh1)
        feat3 = self.siu2(xl2, xm2, xh2)
        feat4= self.siu3(xl3, xm3, xh3)
        feat5 = self.siu4(xl4, xm4, xh4)
