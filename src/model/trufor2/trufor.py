...
from src.model.trufor2.cmx.builder_np_conf import myEncoderDecoder as confcmx
from src.model.trufor2.config import _C as config
from src.model.trufor2.config import update_config
...
class Trufor(nn.Module):
    def __init__(self,
                 ...
                 config_path: str = '/raid/csh/peng555/configs/trufor.yaml',
